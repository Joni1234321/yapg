...
namespace Bserg.Controller.Core
{
    public class SystemGeneratorUpdated
    {
        ...
        public SystemGeneratorUpdated (EntityManager entityManager, Material planetMaterial, Mesh planetMesh, Material orbitMaterial, Material circleMaterial, Mesh quad, Material spacecraftOrbitMaterial, Material spacecraftMaterial) 
        {
            GameObject.Find("System").SetActive(false);
            GameObject.Find("Orbits").SetActive(false);
        
            RenderMeshArray meshArray = new RenderMeshArray(new[] { planetMaterial, orbitMaterial, circleMaterial, spacecraftOrbitMaterial, spacecraftMaterial }, new[] { planetMesh, quad });
